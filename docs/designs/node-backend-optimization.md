...
当前 Node 后端的核心复杂度主要集中在 [`server.js`](/home/jiang/workspace/typescript/nexus4cc/server.js)：
...
- 启动链当前依赖 [`start.sh`](/home/jiang/workspace/typescript/nexus4cc/start.sh) 直接执行 `node server.js`
