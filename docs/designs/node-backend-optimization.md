...
- 启动链已切到 [`start.sh`](/home/demo/workspace/typescript/nexus4cc/start.sh) -> `node dist-server/server.js`
...
部署与重启约束见 [DEPLOYMENT-RUNBOOK.md](/home/demo/workspace/typescript/nexus4cc/docs/DEPLOYMENT-RUNBOOK.md)。
