...
它记录的是 2026-04-02 对旧部署形态做的一次 incident 分析。当前源码树的默认启动链已经切到 [`start.sh`](/home/demo/workspace/typescript/nexus4cc/start.sh) -> Rust `nexus-server`，旧 Node 后端入口和相关业务服务源码已从当前分支删除。
...
- [ARCHITECTURE.md](/home/demo/workspace/typescript/nexus4cc/docs/ARCHITECTURE.md)
- [DEPLOYMENT-RUNBOOK.md](/home/demo/workspace/typescript/nexus4cc/docs/DEPLOYMENT-RUNBOOK.md)
- [code.md](/home/demo/workspace/typescript/nexus4cc/docs/code.md)
...
| 确保 systemd 真正托管 supervisor | 仍然有效，但应按当前 [DEPLOYMENT-RUNBOOK.md](/home/demo/workspace/typescript/nexus4cc/docs/DEPLOYMENT-RUNBOOK.md) 执行 |
...
如果需要当前架构、启动链或部署步骤，请直接看 [ARCHITECTURE.md](/home/demo/workspace/typescript/nexus4cc/docs/ARCHITECTURE.md) 和 [DEPLOYMENT-RUNBOOK.md](/home/demo/workspace/typescript/nexus4cc/docs/DEPLOYMENT-RUNBOOK.md)。
